...
public class LunarCalendar {
	...
	public String getLunarDate(int year_log, int month_log, int day_log, boolean isday) {
		...
		yearCyl = iYear - 1864;
		leapMonth = leapMonth(iYear); // 闰哪个月,img_1-12
		leap = false;
	...
	public String toString() {
		if (chineseNumber[month - 1] == "一" && getChinaDayString(day) == "初一")
			...
			return getChinaDayString(day);
		// return year + "年" + (leap ? "闰" : "") + chineseNumber[month - img_1] +
		// "月" + getChinaDayString(day);
	}
	
	/*public static void main(String[] args) {
		System.out.println(new LunarCalendar().getLunarDate(2012, img_1, 23));
	}*/
